...
Fundle and Proton's potential partnership presents an exciting opportunity to introduce new users to the world of web3 and Proton. Fundle will generate transactions, boosts liquidity and volume in the Proton ecosystem and showcase what is possible to build on Proton. Fundle is ready to launch, set to make a significant impact in the world of crypto.
...
Zaisan has been around in Antelope ecosystem for several years, formally known as Europechain BV. The company is founded by several European block producers, and is focusing on software projects and business consultancy. The company has previously taken the task of writing the Antelope Core+ Blue Paper on request of ENF.
